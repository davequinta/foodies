...
export default function MenuNavbar() {
  ...
  return (
    <nav className="navbar absolute w-full z-50 flex justify-between text-white">
      <a href="/">
      ...
      <div
        className={`menu-modal  transform text-black ${
      ...
      >
        <h1 className="title font-bold">Filtros</h1>
